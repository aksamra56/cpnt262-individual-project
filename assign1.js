        ...
        .then(data => {
            ...
            .then(data => {
                ...
                function displayPicsCountry(pic){
                 ...
                 // Picture details to display
                    function displayPics(gal, galTitle, img){ 
                            img.src = "https://storage.googleapis.com/assignment1_web2/square150/" + gal;
                            img.alt = galTitle;
                        };
                
                    function mobilePic(gal, source){
                        source.srcset = "https://storage.googleapis.com/assignment1_web2/square75/" + gal;
                    ...
                    if(e.target && e.target.nodeName == "IMG"){
                        ...
                        for (p of pictures){
                            if(e.target.alt == p.title){
                                ...
                                img.src = "https://storage.googleapis.com/assignment1_web2/medium800/" + p.filename;
                                
                                let source = document.createElement('sorce');
                                source.srcset = "https://storage.googleapis.com/assignment1_web2/medium640/" + p.filename;
                                source.media = "(min-width: 600px)";
                                
                                //document.querySelector('div.i').appendChild(source); 
  
                                document.querySelector('div.i').style.backgroundImage ="url(" + 'https://storage.googleapis.com/assignment1_web2/medium800/' + p.filename + ')';
                ...
                function countryMap(gal){
                    let img = document.createElement('img');
                    img.src = 'https://maps.googleapis.com/maps/api/staticmap?autoscale=false&size=600x300&maptype=roadmap&key=AIzaSyCzzAL5uy4nPTub5D_OhVo0oF20Arov7jE&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:%7C' + gal.name;
                ...
                function cityMap(gal){
                    let img = document.createElement('img');
                    img.src = 'https://maps.googleapis.com/maps/api/staticmap?center='+ gal.name +',' + gal.iso + '&zoom=9&scale=1&size=500x250&markers=color:blue%7Clabel:S%7C' + gal.latitude + ',' + gal.longitude + '&maptype=roadmap&key=AIzaSyCzzAL5uy4nPTub5D_OhVo0oF20Arov7jE&format=png&visual_refresh=true';
                    document.querySelector('div.g').appendChild(img); 
                } 
                ...
                function pictureMap(gal){
                    let img = document.createElement('img');
                    img.src = 'https://maps.googleapis.com/maps/api/staticmap?center='+ gal.location.city +',' + gal.location.iso + '&zoom=9&scale=1&size=500x250&markers=color:blue%7Clabel:S%7C' + gal.location.latitude + ',' + gal.location.longitude + '&maptype=roadmap&key=AIzaSyCzzAL5uy4nPTub5D_OhVo0oF20Arov7jE&format=png&visual_refresh=true';
